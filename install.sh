...
install_soga() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/soga.tar.gz https://codeload.github.com/RManLuo/crack-soga-v2ray/tar.gz/refs/tags/2.0.6
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://codeload.github.com/RManLuo/crack-soga-v2ray/tar.gz/refs/tags/2.0.6"
